    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text(isFull ? 'Acesso Bloqueado' : 'Acesso Liberado',style: TextStyle(color: Color(0xffffffff),fontSize: 40,fontWeight: FontWeight.w500),),
            Text(count.toString(),style: TextStyle(color: Color(0xffffffff),fontSize: 40,fontWeight: FontWeight.w500)
            ,),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
